...
--
-- Class PhoneIdHash as table serverpod_auth_sms_phone_id_hash
--
...
-- Indexes
CREATE UNIQUE INDEX "serverpod_auth_sms_phone_id_hash_phone" ON "serverpod_auth_sms_phone_id_hash" USING btree ("phoneHash");
CREATE UNIQUE INDEX "serverpod_auth_sms_phone_id_hash_auth_user" ON "serverpod_auth_sms_phone_id_hash" USING btree ("authUserId");
...
--
-- Foreign relations for "serverpod_auth_sms_phone_id_hash" table
--
ALTER TABLE ONLY "serverpod_auth_sms_phone_id_hash"
    ADD CONSTRAINT "serverpod_auth_sms_phone_id_hash_fk_0"
...
--
-- MIGRATION VERSION FOR serverpod_auth_sms_hash
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_sms_hash', '20260131191309024', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260131191309024', "timestamp" = now();
