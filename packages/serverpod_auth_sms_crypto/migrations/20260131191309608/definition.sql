...
--
-- Class PhoneIdCrypto as table serverpod_auth_sms_phone_id_crypto
--
...
-- Indexes
CREATE UNIQUE INDEX "serverpod_auth_sms_phone_id_crypto_phone" ON "serverpod_auth_sms_phone_id_crypto" USING btree ("phoneHash");
CREATE UNIQUE INDEX "serverpod_auth_sms_phone_id_crypto_auth_user" ON "serverpod_auth_sms_phone_id_crypto" USING btree ("authUserId");
...
--
-- Class SmsAccount as table serverpod_auth_sms_account
--
CREATE TABLE "serverpod_auth_sms_account" (
    "id" uuid PRIMARY KEY DEFAULT gen_random_uuid_v7(),
    "authUserId" uuid NOT NULL,
    "createdAt" timestamp without time zone NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- Indexes
CREATE UNIQUE INDEX "serverpod_auth_sms_account_auth_user" ON "serverpod_auth_sms_account" USING btree ("authUserId");

--
-- Class SmsAccountRequest as table serverpod_auth_sms_account_request
--
CREATE TABLE "serverpod_auth_sms_account_request" (
    "id" uuid PRIMARY KEY DEFAULT gen_random_uuid_v7(),
    "createdAt" timestamp without time zone NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "phoneHash" text NOT NULL,
...
-- Indexes
CREATE UNIQUE INDEX "serverpod_auth_sms_account_request_phone_hash" ON "serverpod_auth_sms_account_request" USING btree ("phoneHash");

--
-- Class SmsBindRequest as table serverpod_auth_sms_bind_request
--
CREATE TABLE "serverpod_auth_sms_bind_request" (
    "id" uuid PRIMARY KEY DEFAULT gen_random_uuid_v7(),
    "createdAt" timestamp without time zone NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "authUserId" uuid NOT NULL,
    "phoneHash" text NOT NULL,
    "challengeId" uuid NOT NULL,
    "bindChallengeId" uuid
);

-- Indexes
CREATE INDEX "serverpod_auth_sms_bind_request_auth_user" ON "serverpod_auth_sms_bind_request" USING btree ("authUserId");

--
-- Class SmsLoginRequest as table serverpod_auth_sms_login_request
--
CREATE TABLE "serverpod_auth_sms_login_request" (
    "id" uuid PRIMARY KEY DEFAULT gen_random_uuid_v7(),
    "createdAt" timestamp without time zone NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "phoneHash" text NOT NULL,
    "challengeId" uuid NOT NULL,
...
-- Indexes
CREATE UNIQUE INDEX "serverpod_auth_sms_login_request_phone_hash" ON "serverpod_auth_sms_login_request" USING btree ("phoneHash");
...
--
-- Foreign relations for "serverpod_auth_sms_phone_id_crypto" table
--
ALTER TABLE ONLY "serverpod_auth_sms_phone_id_crypto"
    ADD CONSTRAINT "serverpod_auth_sms_phone_id_crypto_fk_0"
...
--
-- Foreign relations for "serverpod_auth_sms_account" table
--
ALTER TABLE ONLY "serverpod_auth_sms_account"
    ADD CONSTRAINT "serverpod_auth_sms_account_fk_0"
    FOREIGN KEY("authUserId")
    REFERENCES "serverpod_auth_core_user"("id")
    ON DELETE CASCADE
    ON UPDATE NO ACTION;
...
--
-- Foreign relations for "serverpod_auth_sms_account_request" table
--
ALTER TABLE ONLY "serverpod_auth_sms_account_request"
    ADD CONSTRAINT "serverpod_auth_sms_account_request_fk_0"
    FOREIGN KEY("challengeId")
    REFERENCES "serverpod_auth_idp_secret_challenge"("id")
    ON DELETE CASCADE
    ON UPDATE NO ACTION;
ALTER TABLE ONLY "serverpod_auth_sms_account_request"
    ADD CONSTRAINT "serverpod_auth_sms_account_request_fk_1"
...
--
-- Foreign relations for "serverpod_auth_sms_bind_request" table
--
ALTER TABLE ONLY "serverpod_auth_sms_bind_request"
    ADD CONSTRAINT "serverpod_auth_sms_bind_request_fk_0"
    FOREIGN KEY("authUserId")
    REFERENCES "serverpod_auth_core_user"("id")
    ON DELETE CASCADE
    ON UPDATE NO ACTION;
ALTER TABLE ONLY "serverpod_auth_sms_bind_request"
    ADD CONSTRAINT "serverpod_auth_sms_bind_request_fk_1"
    FOREIGN KEY("challengeId")
    REFERENCES "serverpod_auth_idp_secret_challenge"("id")
    ON DELETE CASCADE
    ON UPDATE NO ACTION;
ALTER TABLE ONLY "serverpod_auth_sms_bind_request"
    ADD CONSTRAINT "serverpod_auth_sms_bind_request_fk_2"
    FOREIGN KEY("bindChallengeId")
    REFERENCES "serverpod_auth_idp_secret_challenge"("id")
    ON DELETE CASCADE
    ON UPDATE NO ACTION;

--
-- Foreign relations for "serverpod_auth_sms_login_request" table
--
ALTER TABLE ONLY "serverpod_auth_sms_login_request"
    ADD CONSTRAINT "serverpod_auth_sms_login_request_fk_0"
    FOREIGN KEY("challengeId")
    REFERENCES "serverpod_auth_idp_secret_challenge"("id")
    ON DELETE CASCADE
    ON UPDATE NO ACTION;
ALTER TABLE ONLY "serverpod_auth_sms_login_request"
    ADD CONSTRAINT "serverpod_auth_sms_login_request_fk_1"
...
--
-- MIGRATION VERSION FOR serverpod_auth_sms_crypto
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_sms_crypto', '20260131191309608', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260131191309608', "timestamp" = now();
...
--
-- MIGRATION VERSION FOR serverpod_auth_sms_core
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_sms_core', '20260131191308569', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260131191308569', "timestamp" = now();
